...
export class Program extends BaseProgram {
    ...
    async run() {
        ...
        program
            ...
            .action(
                async (clientId: string, clientSecret: string, options: program.OptionValues) => {
        ...
        program
            ...
            .on("--help", () => {
                ...
                writeLn("");
                writeLn(
                    "    Returns empty response if no sync has been performed for the given object."
                );
                writeLn("");
                writeLn("  Examples:");
                writeLn("");
        ...
        program
            ...
            .option(
                ...
                "Read secret from the named environment variable."
            )
        ...
        program
            ...
            .action(() => {
                this.processResponse(
                    Response.success(
                        new StringResponse(path.join(this.main.dataFilePath, "data.json"))
                    )
                );
            });
