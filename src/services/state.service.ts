...
export class StateService extends BaseStateService<Account> implements StateServiceAbstraction {
    ...
    async getLdapKey(options?: StorageOptions): Promise<string> {
        ...
        return await this.secureStorageService.get<string>(`${options.userId}_${SecureStorageKeys.ldap}`);
    }
    ...
    async setLdapKey(value: string, options?: StorageOptions): Promise<void> {
        ...
        await this.secureStorageService.save(`${options.userId}_${SecureStorageKeys.ldap}`, value, options);
    }
    ...
    async getGsuiteKey(options?: StorageOptions): Promise<string> {
        ...
        return await this.secureStorageService.get<string>(`${options.userId}_${SecureStorageKeys.gsuite}`);
    }
    ...
    async setGsuiteKey(value: string, options?: StorageOptions): Promise<void> {
        ...
        await this.secureStorageService.save(`${options.userId}_${SecureStorageKeys.gsuite}`, value, options);
    }
    ...
    async getAzureKey(options?: StorageOptions): Promise<string> {
        ...
        return await this.secureStorageService.get<string>(`${options.userId}_${SecureStorageKeys.azure}`);
    }
    ...
    async setAzureKey(value: string, options?: StorageOptions): Promise<void> {
        ...
        await this.secureStorageService.save(`${options.userId}_${SecureStorageKeys.azure}`, value, options);
    }
    ...
    async getOktaKey(options?: StorageOptions): Promise<string> {
        ...
        return await this.secureStorageService.get<string>(`${options.userId}_${SecureStorageKeys.okta}`);
    }
    ...
    async setOktaKey(value: string, options?: StorageOptions): Promise<void> {
        ...
        await this.secureStorageService.save(`${options.userId}_${SecureStorageKeys.okta}`, value, options);
    }
    ...
    async getOneLoginKey(options?: StorageOptions): Promise<string> {
        ...
        return await this.secureStorageService.get<string>(`${options.userId}_${SecureStorageKeys.oneLogin}`);
    }
    ...
    async setOneLoginKey(value: string, options?: StorageOptions): Promise<void> {
        ...
        await this.secureStorageService.save(`${options.userId}_${SecureStorageKeys.oneLogin}`, value, options);
    }
    ...
    async getUserDelta(options?: StorageOptions): Promise<string> {
        ...
        return await this.secureStorageService.get<string>(`${options.userId}_${SecureStorageKeys.userDelta}`);
    }
    ...
    async setUserDelta(value: string, options?: StorageOptions): Promise<void> {
        ...
        await this.secureStorageService.save(`${options.userId}_${SecureStorageKeys.userDelta}`, value, options);
    }
    ...
    async getGroupDelta(options?: StorageOptions): Promise<string> {
        ...
        return await this.secureStorageService.get<string>(`${options.userId}_${SecureStorageKeys.groupDelta}`);
    }
    ...
    async setGroupDelta(value: string, options?: StorageOptions): Promise<void> {
        ...
        await this.secureStorageService.save(`${options.userId}_${SecureStorageKeys.groupDelta}`, value, options);
    }
    ...
    async getLdapConfiguration(options?: StorageOptions): Promise<LdapConfiguration> {
        return (await this.getAccount(this.reconcileOptions(options, await this.defaultOnDiskOptions())))
    ...
    async setGsuiteConfiguration(value: GSuiteConfiguration, options?: StorageOptions): Promise<void> {
        const account = await this.getAccount(this.reconcileOptions(options, await this.defaultOnDiskOptions()));
    ...
    async setOneLoginConfiguration(value: OneLoginConfiguration, options?: StorageOptions): Promise<void> {
        const account = await this.getAccount(this.reconcileOptions(options, await this.defaultOnDiskOptions()));
    ...
    protected async scaffoldNewAccountDiskStorage(account: Account): Promise<void> {
        const storedState = await this.storageService.get<State<Account>>('state', await this.defaultOnDiskLocalOptions()) ?? new State<Account>();
